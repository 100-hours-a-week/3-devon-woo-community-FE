            ...
            <form class="edit-form" id="profileForm">
              <section class="form-section image-section">
                <div class="profile-image-wrapper">
                  <img src="${this.escapeHTML(this.state.profileImageUrl || 'https://via.placeholder.com/160')}" alt="Profile" class="profile-image" id="profileImagePreview" />
                </div>
                ...
                <p class="image-hint">JPG, PNG, GIF (최대 5MB)</p>
              </section>
              ...
              <section class="form-section">
                ...
                <div class="form-group">
                  ...
                  />
                  <p class="form-hint">예: 클라우드와 분산 시스템을 사랑하는 백엔드 개발자</p>
                </div>
              </section>
              ...
              <section class="form-section">
                ...
                <div class="form-group">
                  <label for="primaryStackInput" class="form-label">주요 기술 스택 <span class="label-optional">쉼표로 구분</span></label>
                  <input
                    type="text"
                ...
                <div class="form-group">
                  <label for="interestsInput" class="form-label">관심 분야 <span class="label-optional">쉼표로 구분</span></label>
                  <input
                    type="text"
                    id="interestsInput"
                    class="form-input"
                    placeholder="서버 아키텍처, 대규모 트래픽 처리"
              ...
              <section class="form-section">
                ...
                <p class="section-subtitle">소셜 미디어 및 웹사이트 링크를 추가하세요</p>
              ...
              <div class="form-actions">
                ...
                <button type="submit" class="btn-primary" id="saveBtn" ${this.state.isSaving ? 'disabled' : ''}>
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M13.333 14H2.667A.667.667 0 0 1 2 13.333V2.667C2 2.298 2.298 2 2.667 2h7.666L14 5.667v7.666a.667.667 0 0 1-.667.667z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M11.333 14v-5.333H4.667V14M4.667 2v3.333h5.666" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
